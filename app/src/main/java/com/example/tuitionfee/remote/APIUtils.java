...
public class APIUtils {
    ...
    public static final String API_URL = "http://192.168.22.2:5000/";
    ...
    public static StudentSevice getStudentService() {
        return RetrofitClient.getClient(API_URL).create(StudentSevice.class);
    }
